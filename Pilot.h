...
{
	out << " Pilot surname " << pilot.getSurname() << " work Experience  " << pilot.getworkExperienceYears() << " Years | address " << pilot.getAddress() << " Date Of Birth " << pilot.getDateOfBirth() << " salary " << pilot.getSalary() << std::endl;
	return out;
}
